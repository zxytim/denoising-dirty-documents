#!/usr/bin/env python2
# -*- coding: utf-8 -*-
# $File: first.maxout.rect_inp.py
# $Date: Wed Sep 30 13:56:58 2015 +0800
...
def get_model():
    model = Sequential()
    model.add(Convolution2D(16, 1, 2, 3))
    model.add(Activation('relu'))
    model.add(Maxout(2))

    model.add(Convolution2D(16, 16 / 2, 2, 3))
    model.add(Activation('relu'))
    model.add(Maxout(2))

    model.add(Convolution2D(24, 16 / 2, 2, 3))
    model.add(Activation('relu'))
    model.add(Maxout(2))

    model.add(Convolution2D(32, 24 / 2, 2, 3))
    model.add(Activation('relu'))
    model.add(Maxout(2))

    model.add(Convolution2D(48, 32 / 2, 1, 15))
    model.add(Activation('relu'))
    model.add(Maxout(2))
