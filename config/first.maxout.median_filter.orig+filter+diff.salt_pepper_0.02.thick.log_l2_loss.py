...
def get_model():
    model = Sequential()
    model.add(Convolution2D(32, 5, 3, 3))
    model.add(Activation('relu'))
    model.add(Maxout(2))

    model.add(Convolution2D(32, 32/ 2, 3, 3))
    model.add(Activation('relu'))
    model.add(Maxout(2))
    ...
    model.add(Convolution2D(64, 48/ 2, 3, 3))
    model.add(Activation('relu'))
    model.add(Maxout(2))

    model.add(Convolution2D(96, 64/ 2, 3, 3))
    model.add(Activation('relu'))
    model.add(Maxout(2))

    # 1x1 here

    model.add(Convolution2D(1, 96/ 2, 1, 1))  # a fully connected layer
